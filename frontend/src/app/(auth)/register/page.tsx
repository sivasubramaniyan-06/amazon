...
export default function RegisterPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    setIsLoading(true);
    // Mock registration -> verification step
    setTimeout(() => {
      setIsLoading(false);
  ...
  return (
    <div className="bg-card border border-border/60 rounded-3xl p-8 shadow-xl">
      ...
      <p className="text-muted-foreground text-sm mb-6">Join ShopArc for a premium shopping experience</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Button type="submit" className="w-full h-12 rounded-full text-base font-semibold mt-6" disabled={isLoading}>
